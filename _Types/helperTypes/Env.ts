declare global {
  namespace NodeJS {
    interface ProcessEnv {
      ...
      CLOUDFLARE_PUBLIC_DOMAIN_DEVELOPMENT: string;
      CLOUDFLARE_BUCKET_NAME_DEVELOPMENT: string;
      CLOUDFLARE_ZONE_ID_DEVELOPMENT: string;
      CLOUDFLARE_ZONE_CACHE_PURGE_TOKEN_DEVELOPMENT: string;
      ...
      CLOUDFLARE_PUBLIC_DOMAIN_PRODUCTION: string;
      CLOUDFLARE_BUCKET_NAME_PRODUCTION: string;
      CLOUDFLARE_ZONE_ID_PRODUCTION: string;
      CLOUDFLARE_ZONE_CACHE_PURGE_TOKEN_PRODUCTION: string;
