...
import { QueueOptions, UserDeletedType } from "@Types/events/OutboxEvents";
...
async function userDeletedQueue(queueName: UserDeletedType["queueName"], queueOptions?: QueueOptions) {
