...
import { StoreOwnerDeletedType } from "@Types/events/OutboxEvents";
...
async function storeOwnerDeletedPublisher(event: StoreOwnerDeletedEvent) {
...
export default storeOwnerDeletedPublisher;
