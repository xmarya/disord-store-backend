...
import { QueueOptions, StoreSuspendedType } from "@Types/events/OutboxEvents";
...
async function storeSuspendedQueue(queueName: StoreSuspendedType["queueName"], queueOptions?: QueueOptions) {
...
export default storeSuspendedQueue;
