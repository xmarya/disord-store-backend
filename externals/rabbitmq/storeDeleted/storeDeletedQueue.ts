...
import { QueueOptions, StoreDeletedType } from "@Types/events/OutboxEvents";
...
async function storeDeletedQueue(queueName: StoreDeletedType["queueName"], queueOptions?: QueueOptions) {
