...
export const createOne = (Model: Exclude<Model, "User">) => catchAsync( async(request, response, next) => {
...
export const deleteOne = (Model:Exclude<Model, "User">) => catchAsync( async (request, response, next) => {
