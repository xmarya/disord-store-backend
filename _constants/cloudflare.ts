...
export const cloudflareConfig: CloudflareConfig = {
  development: {
    ...
    zoneId: process.env.CLOUDFLARE_ZONE_ID_DEVELOPMENT,
    zoneCachePurgeToken: process.env.CLOUDFLARE_ZONE_CACHE_PURGE_TOKEN_DEVELOPMENT,
  ...
  production: {
    ...
    zoneId: process.env.CLOUDFLARE_ZONE_ID_PRODUCTION,
    zoneCachePurgeToken: process.env.CLOUDFLARE_ZONE_CACHE_PURGE_TOKEN_PRODUCTION,
