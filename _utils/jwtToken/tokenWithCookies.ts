...
// this function will make the token to be sent with requests and stored in the browser via cookies.
    const cookieOpt:CookieOptions = {
        ...
        httpOnly: false, /* CHANGE LATER: to true after deploying the front-end */ // means the cookie can't be accessed or modified in anyway by the browser in client's machine which help us avoiding the XSS attacks. but this
